...
<DIv class ="container m-4 p-4">
	...
	<form:form action="additemoffoodorder" modelAttribute="item">
		<div class="mb-3">
			<label for="name" class="form-label">Item Name </label>
			<form:input path="name" class="form-control" id="name"
				value="<%=i.getName() %>" disabled="true"  />
		</div>
		<div class="mb-3">
			<label for="exampleInputEmail1" class="form-label">Item Type
			</label>
			<form:input path="type" value="<%=i.getType() %>"
				class="form-control" id="exampleInputEmail1" disabled="true" />
		</div>
		<div class="mb-3">
			<label for="exampleInputPassword1" class="form-label">Cost of
				Item</label>
			<form:input path="cost" value="<%=i.getCost() %>"
				class="form-control" id="exampleInputEmail1" disabled="true" />
		</div>
		<div class="mb-3">
			<label for="exampleInputPassword1" class="form-label">Quantity
				of Product</label>
			<form:input path="quentity" value="<%=i.getQuentity() %>"
